package com.darrenchan.government.controller;

import com.darrenchan.government.bean.GovernmentDetail;
import com.darrenchan.government.service.TableLineageService;
...
public class GovernmentController {
    ...
    public String getLineage() {
        ...
        // 从neo4j中查询所有边以及顶点，并绘成`Mermaid.js`字符串
        var driver = GraphDatabase.driver("bolt://localhost:7687", AuthTokens.basic("neo4j", "chen!!1992062812"));
